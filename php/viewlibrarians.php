...
die("Connection failed: " . $conn->connect_error);
 ...
 $email = $_SESSION['Email'];
$sql = "SELECT `Librarian_ID`, `Fullname`, `Email_Address`, `Phone_Number`, `Recovery_Question`, `Recovery_Answer` FROM `librarian`";
...
<br>
<br>
<label>To add a librarian into the system, click <a href="reg_librarian.php">HERE</a>.</lable>
<br>
<br>
<div style="width: 45%; margin-left: 30%;">
<label style="text-align: center;">To delete a librarian, kindly input the Librarian ID in the field below:</label>
<br>
<br>
