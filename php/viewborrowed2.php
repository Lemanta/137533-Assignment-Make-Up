...
<head>
<title>Articles & Books Management  - View Borrowed Articles & Bookss Page</title>
...
<div id="bodymiddlePan" style="text-align: center;">
  ...
  <div style="text-align: center;">
   <p>Below are the Articles & Bookss that you have borrowed :</p> <br><br>
</div>
   <table id="printTable">
...
die("Connection failed: " . $conn->connect_error);
 ...
 $email = $_SESSION['Email'];
$sql = "SELECT * FROM `borrowed_Articles & Bookss` WHERE `Email_Address` = '$email'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
echo "<tr><td>" . $row["Borrow_ID"] . "</td><td>" . $row["Articles & Books_ID"] . "</td><td>" . $row["Email_Address"]. "</td><td>" . $row["Date_Of_Borrow"]. "</td><td>" . $row["Date_To_Return"]. "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
...
<br>
<br>
<label>To return a Articles & Books, kindly input the Borrow ID and your Email Address in the fields below:</lable>
<br>
<br>
<form method="POST" action="return.php">
<input type="text" name="bid" placeholder="Borrow ID...">
<br>
<br>
<input type="text" name="uemail" placeholder="User Email...">
<br>
<br>
<button type="submit" name="return">Return Articles & Books</button>
<br>
<br>
</form>
</div>
