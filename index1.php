...
<div id="bodymiddlePan">
  ...
  <div><a style="background-color: white; border-radius: 25px; padding: 12px 25px;  box-shadow: 0 0 5px black;" href="php/viewArticles & Bookss.php">View Articles & Bookss</a></div><br><br><br>
  <div><a style="background-color: white; border-radius: 25px; padding: 12px 25px;  box-shadow: 0 0 5px black;" href="php/viewborrowed.php">View Borrowed Articles & Bookss</a></div><br><br><br> 
<div><a style="background-color: white; border-radius: 25px; padding: 12px 25px;  box-shadow: 0 0 5px black;" href="php/viewreturned.php">View Returned Articles & Bookss</a></div><br><br><br>
<div><a style="background-color: white; border-radius: 25px; padding: 12px 25px;  box-shadow: 0 0 5px black;" href="php/viewlibrarians.php">View Librarians</a></div><br><br><br>  
<div><a style="background-color: white; border-radius: 25px; padding: 12px 25px;  box-shadow: 0 0 5px black;" href="php/viewusers.php">View Users</a></div><br><br><br>
</div>
</div>
<br>
<br>
...
<!-- <div id="bottomPan">
  <div id="bottomMainPan">
    <div id="bottomBorderPan">
      ...
      <ul>
        <li><a href="php/aArticles & Bookss1.php">Fiction</a></li>
        <li><a href="php/aArticles & Bookss1.php">Educational</a></li>
        <li><a href="php/aArticles & Bookss1.php">Religous</a></li>
        <li><a href="php/aArticles & Bookss2.php">Film Scripts</a></li>
        <li><a href="php/aArticles & Bookss2.php">Past Papers</a></li>
        <li><a href="php/aArticles & Bookss2.php">Biographies</a></li>
      </ul>
    </div>
  </div>
</div> -->
